...
echo ""
echo "2. Update nginx configuration on server:"
echo "   docker-compose -f docker-compose.prod.yml stop nginx"
echo "   docker-compose -f docker-compose.prod.yml rm nginx"
echo "   # Update docker-compose.prod.yml nginx volumes to use nginx-cloudflare-ssl.conf"
